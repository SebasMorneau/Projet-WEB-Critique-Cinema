...
<div class="corps">
			...
			<div class="feed">
				...
				<div class="boiteEcrire">
					<form class="ecritureCritique" action="nouvelleCritique.php" method="post" enctype="multipart/form-data">
						...
						<button id="boutonEcrire" type="submit">Publier</button>
					</form>
				</div>
			...
			<div>
				...
				<div class="critique">
					...
					<!-- ADMIN -->
					<a href="modifierCritique.php?critiqueId=<?= $critique["CRITIQUEID"] ?>">Modifier</a>
					<a href="deleteCritique.php?critiqueId=<?= $critique["CRITIQUEID"] ?>">Supprimer</a>
